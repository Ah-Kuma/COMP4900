...
public class HealthyDroidQuizHelper extends SQLiteOpenHelper
{
	...
	private static String CREATE_TABLE_ASSOCIATION = "create table"
			+ TABLE_ASSOCIATION + "( " + COLUMN_QUESTION_ID + " integer primary key, "
			+ "FOREIGN KEY (" + COLUMN_QUESTION_ID + ") REFERENCES " + TABLE_QUESTION
			+ " (" + COLUMN_ID + "), " + COLUMN_ANSWER + " text not null, "
			+ "FOREIGN KEY (" + COLUMN_ANSWER + ") REFERENCES " + TABLE_ANSWER
			+ " (" + COLUMN_ANSWER +"), " + COLUMN_DATETIME + " text primary key, "

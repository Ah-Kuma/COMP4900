...
public class QuestionFactory
{
     ...
     * @param questionTypeOptions the string representing the options for the question type.
     * @param questionText the text for the question query.
     * @return a subclass of Question
     * @throws ClassNotFoundException if the type indicated in classType cannot be found.
     */
    public <T extends Question> T Create(String classType,
                                         String questionTypeOptions,
                                         String questionText)
        throws ClassNotFoundException
    {
        ...
        try
        {
            ...
            question = constructor.newInstance(questionTypeOptions,
                                               questionText);
        }
